    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.notificationFavContainer}>
                <Pressable style={styles.notificationIcon} onPress={() => navigation.navigate("NotificationsScreen")}>
                    <Ionicons name={"notifications-outline"} color={"#1862b7"} size={34} />
                </Pressable>
                <Pressable style={styles.iconContainer} onPress={() => navigation.navigate("FavoriteDrScreen")}>
